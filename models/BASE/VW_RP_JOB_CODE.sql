...
WITH source -- the CTE view name
	AS(
     SELECT JOBCODEINTID AS JOB_CODE_ID
          ...
          , to_boolean(DIRECT) AS DIRECT_FLG
          , to_boolean(ISBREAK) AS BREAK_FLG
          , to_boolean(ISMEASURED) AS MEASURED_FLG
          , to_boolean(ISPAID) AS PAID_FLG
          , to_boolean(REQ_APPROVAL) AS REQ_APPROVAL_FLG
